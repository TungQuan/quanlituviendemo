			...
			<table  class="table table-stripper table-hover" id="table">
				...
				<thead class="title-thead">
					<tr>
                        ...
                        <th class="noshow">Sửa</th>
                        <th class="noshow">Xóa</th>
                        <th class="noshow">Chi Tiết</th>
					</tr>
				</thead>
				<tbody class="title-tbody">
					...
					<tr>
						...
						<td align="center" class="noshow">
                                 <a href="admincaptinh/tuvien/chinhsua/{{$tv->TuVienID}}" ><i class="fa fa-pencil " style="font-size: 16px"></i>
                                </a>
                               
                            </td>
                            <td align="center" class="noshow">
                                <a  href="admincaptinh/tuvien/xoa/{{$tv->TuVienID}}"class="delete-button"><i class="fa fa-trash " style="font-size: 16px"></i>
                                </a>
                            </td>
                            <td align="center" class="noshow">
                                <a  href="admincaptinh/tuvien/chitiet/{{$tv->TuVienID}}"class="delete-button"><i class="fa fa-info-circle" style="font-size: 16px"></i>
                                </a>
                            </td>
					</tr>
					@endforeach
