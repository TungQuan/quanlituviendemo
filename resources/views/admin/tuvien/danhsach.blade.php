    ...
    <div class="container-fluid" >
        <div class="row">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="admin/tuvien/danhsach">Trang chủ</a></li>
        ...
        <div class="row">
            <div class="table-wrap">
                <table class="main-table table table-striped" id="dataTables">
                    ...
                    <tbody id="tablefilter">
                        ...
                        <tr class="title-tr">
                            <td align="center" id="stt">@php echo $i; $i++; @endphp</td>
                            <td>{{$tv->TuVien_Ten}}</td>
                            <td>{{$tv->XaPhuong_Ten}}</td>
                            <td>{{$tv->QuanHuyen_Ten}}</td>
                            <td>{{$tv->TrangThai_Ten}}</td>
                            <td class="center" align="center"><a href="admin/tangni/danhsach/{{$tv->TuVienID}}"><i class="glyphicon glyphicon-list-alt" style="font-size: 20px;"></i></a></td>
                        </tr>
                        @endforeach
                    </tbody> 
                </table>
