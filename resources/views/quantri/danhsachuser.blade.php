...
<html>
	<head>
		...
		div.table thead{
		 ...
		 span.help_admin_captinh{
		 	cursor: pointer;
		 	color: blue; 
		 	text-decoration: underline;
		}
		 span.help_admin_captinh:hover{
		 	font-weight: bold;
		 }
		</style>
	</head>
			...
			<div class="row">
				...
				<div class="col-md-10 ">
					<div class="right-content">
						<div class="row">
							<div class="col-md-2 captinh"><a href="quantri/quanliuser/danhsachuser"><button class="btn btn-primary button activebutton" type="button">Quản Lí Cấp Tỉnh</button></a></div>
							<div class="col-md-2 caphuyen"><a href="quantri/quanliuser/usercaphuyen"><button class="btn btn-primary button" type="button">Quản Lí Cấp Huyện</button></a></div>
						...
						<div class="row">
							<div class="table">
								<table class="table table-hover table-bordered table-striped">
									...
									<tbody>
										 @php $i =1; @endphp
                        				 @foreach($usercaptinh as $captinh)
											<tr>
												<td>@php echo $i; $i++; @endphp</td>
												<td>{{$captinh->PhapDanh}}</td>
												<td>{{$captinh->TuVien_Ten}}</td>
												<td>{{$captinh->username}}</td>
												<td>{{$captinh->email}}</td>
												<td><a href="quantri/quanliuser/resetpass/{{$captinh->user_id}}">Đổi Mật Khẩu</a></td>
												<td><a href="quantri/quanliuser/disamble/{{$captinh->user_id}}">Vô Hiệu</a></td>
											</tr>
										@endforeach
									</tbody>
								</table>
								<div clas="help"><span class="help_admin_captinh" id="guildline">Xem Hướng Dẫn</span></div>
