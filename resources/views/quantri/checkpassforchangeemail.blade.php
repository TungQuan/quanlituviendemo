			...
			<div class="row">
				...
				<div class="col-md-10">
					<div class="userinfo-row-right" >
						...
						<p>Để cập nhật hộp thư mới, vui lòng xác nhân bằng cách nhập mật khẩu</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-10 ">
					<div class="right-content">
						<form class="form-change-password" action="quantri/doiemail/checkpassforchangeemail" method="POST">
							{!! csrf_field() !!}
							<div class="form-group">
								<label for="oldpass">Nhập Mật Khẩu Của Bạn</label>
								<div class="input">
									<input type="password" class="form-control" name="password" id="password" placeholder="Mật khẩu của bạn" required autofocus>
								</div>
								@if(session('thongbao'))
